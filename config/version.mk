...
HALCYON_VERSION := Ursinia
HALCYON_VERSION_NUMBER := 14.2

HALCYON_BUILD_VERSION := halcyon_$(HALCYON_BUILD)-$(HALCYON_VERSION_NUMBER)-$(HALCYON_HOST_TIME)-$(HALCYON_BUILD_TYPE)
